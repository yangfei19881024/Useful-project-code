define(function(require, exports, module){
	...
	$('[data-action=login]').live('click', function(){
		...
		var content = '<div class="login-outer clearfix">'
					 ...
					 +'			<input type="text" name="user" class="textBox login-user" data-id="login-user-error" placeholder="邮箱 / 手机 / 用户名"/>'
					 +'			<p class="login-error clearfix" id="login-user-error"></p>'
					 +'		</div>'
					 +'		<div class="pt24 clearfix login-pass-outer">'
					 +'			<input type="password" name="pass" class="textBox login-pass" data-id="login-pass-error" placeholder="密码" />'
					 +'			<p class="login-error clearfix" id="login-pass-error"></p>'
					 +'		</div>'
					 +'		<div class="pt24 clearfix login-code-outer" id="verifyCode">'
					 +'			<span class="fl">'
					 +'				<input type="text" name="code" class="textBox login-code" data-id="login-code-error" maxlength="4" placeholder="验证码" />'
					 +'			</span>'
					 +'			<span class="ml24 fl">'
					 ...
					 +'			<a href="javascript:;" class="login-button anim-all">登录</a>'
					 +'		</div>'
					 +'		<div class="pt12 clearfix">'
					 +'			<label for="rememberMe" class="fl"><input type="checkbox" name="rememberMe" id="rememberMe" /> 记住用户名</label>'
					 +'			<div class="fr">'
					 +'				<a href="/signup/index" class="color-blue">注册</a>'
					 +'				<a href="/findpw/index" class="color-blue ml12">忘记密码</a>'
					 +'			</div>'
					 +'		</div>'
					 +'	</div>'
					 ...
					 +'		</div>'
					 +'		<div class="pt24 clearfix">'
					 +'			<a href="/user/thirdLogin?type=sina" class="sina-login fl"><span class="login-sina-icon sprites"></span><span class="pl12">微博</span></a>'
					 +'			<a href="/user/thirdLogin?type=qq" class="qq-login fr"><span class="login-qq-icon sprites"></span><span class="pl12">QQ</span></a>'
					 +'		</div>'
					 +'	</div>'
					 +'</div>';
