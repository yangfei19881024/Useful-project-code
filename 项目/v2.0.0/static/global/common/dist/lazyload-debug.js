 ...
 *
 */
define("static/global/common/2.0.0/lazyload-debug", [], function(require, exports, module) {
    return function($) {
        $.extend({
            lazy_defaults: {
            ...
            lazy_setImg: function(currentImg) {
                ...
                if (src) {
                    ...
                    //{
                    currentImg.attr("src", src).removeAttr("data-image").removeAttr("data-class").css({
                        opacity: 0
                    }).animate({
                        opacity: 1
                    });
